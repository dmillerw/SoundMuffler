 ...
 * @author dmillerw
 */
public class GuiItemSoundMuffler extends GuiScreen {
    ...
    private IItemSoundMuffler magicalEarmuffs;

    private List<SoundEntry> soundEntrySet;

    public GuiItemSoundMuffler(EntityPlayer entityPlayer) {
        this.entityPlayer = entityPlayer;
        this.itemStack = entityPlayer.getHeldItem();
        this.magicalEarmuffs = (IItemSoundMuffler) this.itemStack.getItem();
    ...
    protected void actionPerformed(GuiButton guiButton) {
        if (guiButton.id == 0) {
            ...
            if (selectedIndex != -1) {
                ...
                PacketItemSoundMuffler.removeSoundEntry(soundEntry);
